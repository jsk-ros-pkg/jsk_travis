...
sudo sed -i 's@Depends: python (<< 2.7), python (>= 2.6)@Depends: python (<< 2.8), python (>= 2.7)@' /var/lib/apt/lists/packages.ros.org_ros-shadow-fixed_ubuntu_dists_precise_main_binary-amd64_Packages
